...
(* $Id: hExtlib.ml 10559 2009-11-10 15:11:51Z asperti $ *)
...
exception Localized of unit(*XXX*) * exn

let loc_of_floc floc = (-777,-777)(*XXX*)(*Stdpp.first_pos floc, Stdpp.last_pos floc*);;

let floc_of_loc (loc_begin, loc_end) =
 ()(*XXX*)(*Stdpp.make_loc (loc_begin, loc_end)*)
